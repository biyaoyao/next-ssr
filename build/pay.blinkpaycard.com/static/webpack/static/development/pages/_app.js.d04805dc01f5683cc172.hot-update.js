...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      this.setState({
        show: true,
        router: next_router__WEBPACK_IMPORTED_MODULE_2___default.a.router
    ...
    value: function render() {
      ...
      console.log('render', this.state.router ? this.state.router.asPath : '');
...
//# sourceMappingURL=_app.js.d04805dc01f5683cc172.hot-update.js.map