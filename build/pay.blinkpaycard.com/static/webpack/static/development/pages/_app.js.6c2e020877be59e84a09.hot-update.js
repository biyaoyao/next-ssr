  ...
  _createClass(MyApp, [{
    ...
    value: function render() {
      ...
      if (this.state.project) {
        console.error('project', this.state.project); //const  ProjectEntry = require('../pages/projects/pay.blinkpaycard.com/index');
...
//# sourceMappingURL=_app.js.6c2e020877be59e84a09.hot-update.js.map